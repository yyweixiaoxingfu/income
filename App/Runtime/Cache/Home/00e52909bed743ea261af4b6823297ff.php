...
<link rel="shortcut icon" href="/Public/Home/img/favicon_jianli.ico" type="image/x-icon">


<!-- Bootstrap -->
<link rel="stylesheet" type="text/css"  href="/Public/Home/css/bootstrap.css">
<link rel="stylesheet" type="text/css" href="/Public/Home/fonts/font-awesome/css/font-awesome.css">

<!-- Slider
    ================================================== -->
<link href="/Public/Home/css/owl.carousel.css" rel="stylesheet" media="screen">
<link href="/Public/Home/css/owl.theme.css" rel="stylesheet" media="screen">
...
<link rel="stylesheet" type="text/css" href="/Public/Home/fonts/sns_fonts/iconfont.css">
        ...
        <div class="col-sm-6 col-md-3 col-lg-3 web">
          <div class="portfolio-item">
            <div class="hover-bg">
              ...
              <img src="/Public/Home/img/portfolio/01.jpg" class="img-responsive" alt="欧工商城"></div>
          </div>
        </div>
          ...
          <div class="portfolio-item">
            <div class="hover-bg">
              <div class="hover-text">
                ...
                <div class="clearfix"></div>
                <i class="fa fa-search"></i> </div>
              <img src="/Public/Home/img/portfolio/02.jpg" class="img-responsive" alt="财树理财"></div>
          </div>
        </div>
          ...
          <div class="portfolio-item">
            <div class="hover-bg">
              <div class="hover-text">
                ...
                <div class="clearfix"></div>
                <i class="fa fa-search"></i> </div>
              <img src="/Public/Home/img/portfolio/03.jpg" class="img-responsive" alt="IT技术之家"></div>
          </div>
        </div>
          ...
          <div class="portfolio-item">
            <div class="hover-bg">
              <div class="hover-text">
                ...
                <div class="clearfix"></div>
                <i class="fa fa-search"></i> </div>
              <img src="/Public/Home/img/portfolio/04.jpg" class="img-responsive" alt="久久基因"></div>
          </div>
        </div>
        <div class="col-sm-6 col-md-3 col-lg-3 web">
          <div class="portfolio-item">
            <div class="hover-bg">
              <div class="hover-text">
                ...
                <div class="clearfix"></div>
                <i class="fa fa-search"></i> </div>
              <img src="/Public/Home/img/portfolio/05.jpg" class="img-responsive" alt="纵横基因">
			  </div>
          </div>
        </div>
          ...
          <div class="portfolio-item">
            <div class="hover-bg">
              <div class="hover-text">
                ...
                <div class="clearfix"></div>
                <i class="fa fa-search"></i> </div>
              <img src="/Public/Home/img/portfolio/06.jpg" class="img-responsive" alt="浙江网新恒天UED"></div>
          </div>
        </div>
          ...
          <div class="portfolio-item">
            <div class="hover-bg">
              <div class="hover-text">
                ...
                <div class="clearfix"></div>
                <i class="fa fa-search"></i> </div>
              <img src="/Public/Home/img/portfolio/07.jpg" class="img-responsive" alt="个人博客"></div>
          </div>
        </div>
        <div class="col-sm-6 col-md-3 col-lg-3 web app">
          <div class="portfolio-item">
            ...
            <div class="hover-bg"> 
              ...
              <img src="/Public/Home/img/portfolio/08.jpg" class="img-responsive" alt="软装大师">
		    </div>
          </div>
        </div>
      </div>
...
<div id="about">
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-6"> <img src="/Public/Home/img/about.png" class="img-responsive"> </div>
      <div class="col-md-6">
...
<div id="team" class="text-center">
  <div class="container">
	...
	<div class="col-md-3 col-sm-6">
        <div class="thumbnail"> <img src="/Public/Home/img/team/02.jpg" alt="浙江理工大学" class="img-circle team-img">
          <div class="caption">
            <h3>浙江理工大学</h3>
            <p>电子信息工程</p>
      ...
      <div class="col-md-3 col-sm-6">
        <div class="thumbnail"> <img src="/Public/Home/img/team/01.jpg" alt="杭州归谷培训中心" class="img-circle team-img">
          <div class="caption">
            <h3>杭州归谷培训中心</h3>
            <p>前端培训</p>
      ...
      <div class="col-md-3 col-sm-6">
        <div class="thumbnail"> <img src="/Public/Home/img/team/03.jpg" alt="浙大网新" class="img-circle team-img">
          <div class="caption">
            <h3>浙大网新</h3>
            <p>前端工程师</p>
      ...
      <div class="col-md-3 col-sm-6">
        <div class="thumbnail"> <img src="/Public/Home/img/team/04.jpg" alt="欧工国际" class="img-circle team-img">
          <div class="caption">
            <h3>欧工国际</h3>
            <p>前端工程师</p>
...
<script type="text/javascript" src="/Public/Home/js/SmoothScroll.js"></script>
<script type="text/javascript" src="/Public/Home/js/jquery.prettyPhoto.js"></script>
<script type="text/javascript" src="/Public/Home/js/jquery.isotope.js"></script>
<script type="text/javascript" src="/Public/Home/js/jquery.counterup.js"></script>
<script type="text/javascript" src="/Public/Home/js/waypoints.js"></script>
<script type="text/javascript" src="/Public/Home/js/jqBootstrapValidation.js"></script>
<script type="text/javascript" src="/Public/Home/js/contact_me.js"></script>
